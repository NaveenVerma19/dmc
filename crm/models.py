...
class CompanyKYCDetails(models.Model):
    ...
    productivity_previous = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True)
    productivity_second_previous = models.DecimalField(max_digits=10, decimal_places=2, default=0, blank=True)
