...
class CompanyKYCDetails(models.Model):
    ...
    pancard_file = models.ImageField(null=True, default="Mini_Flower.png")
    gstin = models.CharField(max_length=255)
    gstin_file = models.ImageField(null=True, default="Mini_Flower.png")
    msme_no = models.CharField(max_length=255)
    msme_file = models.ImageField(null=True, default="Mini_Flower.png")
...
class ContactTable(models.Model):
    ...
    company_name = models.ForeignKey(
        CompanyFullKYC, on_delete=models.CASCADE, null=True,)
    person_name = models.CharField(max_length=200)
    ...
    contact_state = models.ForeignKey(State, on_delete=models.SET_NULL, null=True)
    ...
    contact_card = models.ImageField(null=True, blank=True)
    updated = models.DateTimeField(auto_now=True)
    created = models.DateTimeField(auto_now_add=True)
...
class ArivalTable(models.Model):
    ...
    child_pax = models.CharField(max_length=100, blank=True, null=True)
    adt_cost = models.CharField(max_length=100, blank=True, null=True)
    child_cost = models.CharField(max_length=100, blank=True, null=True)
    ...
    part_pmt_amt = models.CharField(max_length=100, blank=True, null=True)
    ...
    purchase_amt = models.CharField(max_length=100, blank=True, null=True)
...
class Feedback(models.Model):
    ...
    suport_file = models.ImageField(blank=True, null=True)
    updated = models.DateTimeField(auto_now=True)
    created = models.DateTimeField(auto_now_add=True)